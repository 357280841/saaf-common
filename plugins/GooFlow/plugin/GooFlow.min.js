    ...
    if (json.type && json.type != "sl") {
        ...
        if (n1.type == "start" || n1.type == "fork" || n1.type == "join") {
            ...
            if (sp[0] == m1[0]) {//垂直
                ...
                x_ = parseInt(L / (1 + (sp[1] - ml[1]) * (sp[1] - ml[1]) / ((sp[0] - ml[0]) * (sp[0] - ml[0]))));
                y_ = parseInt(L / (1 + (sp[0] - ml[0]) * (sp[0] - ml[0]) / ((sp[1] - ml[1]) * (sp[1] - ml[1]))));
...
function processImageDraw(certificate, locationId, processInstanceId, processDefinitionKey, processDefinitionId, businessKey) {

    // var destine = '//192.168.21.116';//测试环境
    var destine =  window.serverAPI || '//119.3.2.199:9001';
    ...
    var _bpm_process_image_post_url = host + "/api/bpmServer/bpmProcessService/getGooflowProcessJSON";
