...
function processImageDraw(api, certificate, locationId, processInstanceId, processDefinitionKey, businessKey, processDefinitionId) {
    ...
    var _bpm_process_image_post_url = api;
