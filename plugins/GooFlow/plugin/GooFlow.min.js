...
function GooFlow(bgDiv, property) {
    ...
    if(width == 0){//未获取到宽度时获取外框的宽度
        width = this.$bgDiv.parent().parent().parent().width();
    }
...
function processImageDraw(api, certificate, locationId, flowParams) {
    //flowParams: processInstanceId, processDefinitionKey, processDefinitionId, businessKey, listId, ouId, responsibilityId, preview
    var property = {
    ...
    $.ajax({
        ...
        data: {
            params: JSON.stringify({
                processInstanceId: flowParams.processInstanceId,
                processDefinitionKey: flowParams.processDefinitionKey,
                processDefinitionId: flowParams.processDefinitionId,
                businessKey:flowParams.businessKey,
                listId:flowParams.listId,
                ouId:flowParams.ouId,
                responsibilityId:flowParams.responsibilityId,
                preview:true
            })
        },
